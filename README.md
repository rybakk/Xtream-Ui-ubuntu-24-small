...
```bash
sudo apt update && rm -rf install.py && wget -qO install.py https://raw.githubusercontent.com/rybakk/Xtream-Ui-ubuntu-24-small/refs/heads/main/install.py && sudo python3 install.py
```
